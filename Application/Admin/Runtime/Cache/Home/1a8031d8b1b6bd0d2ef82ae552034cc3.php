    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                ...
                <input type="hidden" name="id" value="<?php echo ($articler["id"]); ?>"><!-- zheli-->
                            ...
                            <tr>
                             <th><i class="require-red">*</i>文章标题：</th>
                              ...
                              <tr>
                                ...
                                <td>
                                    <textarea style="width: 423px;height: 100px;border-radius: 10px" name="desc"><?php echo ($articler["desc"]); ?></textarea>
                                </td>
                            </tr>
                               <tr>
                               ...
                               <input id="pic" name="pic" type="file" size="50" value="">
                                <?php if($articler['pic'] != ''): ?><img src="/blogs/<?php echo ($articler["pic"]); ?>" height="50"/>
                                 <?php else: ?>
                                 暂无缩略图<?php endif; ?>
                               </td>
                            </tr>
                            <tr>
                             ...
                             <tr>
                                <th><i class="require-red">*</i>内容：</th>
                                 <td>
                                    <textarea style="width: 423px;height: 100px;border-radius: 10px" name="content" id="content"><?php echo ($articler["content"]); ?></textarea>
                                </td>
                            </tr>
