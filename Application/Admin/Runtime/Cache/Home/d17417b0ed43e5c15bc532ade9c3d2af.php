...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/blogs/admin.php/Home/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">链接管理</span></div>
        </div>
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="/blogs/admin.php/Home/Link/sort"  method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/blogs/admin.php/Home/Link/add"><i class="icon-font"></i>新增链接</a>
                        <a id="updateOrd" href="javascript:void(0)"><i class="icon-font"></i>
                        <input class="btn btn-primary btn6 mr10" type="submit" value="更新排序"/>
                        </a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td title="<?php echo ($vo["title"]); ?>"><a target="_blank" title="链接名称"><?php echo ($vo["title"]); ?></a>
                            </td>
                             <td title="<?php echo ($vo["url"]); ?>"><a target="_blank" title="链接地址"><?php echo ($vo["url"]); ?></a>
                            </td>
                            </td>
                             <td title="<?php echo ($vo["desc"]); ?>"><a target="_blank" title="链接描述"><?php echo ($vo["desc"]); ?></a>
                            </td>
                            <td>
                                <a class="link-update" href="/blogs/admin.php/Home/Link/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" onclick="return confirm('确认删除?');" href="/blogs/admin.php/Home/Link/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
