...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/blogs/admin.php/Home/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">管理员管理</span></div>
        </div>
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="/blogs/admin.php/Home/Admin/sort"  method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/blogs/admin.php/Home/Admin/add"><i class="icon-font"></i>新增管理员</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <td><?php echo ($vo["id"]); ?></td>
                            ...
                            <td>
                                <a class="link-update" href="/blogs/admin.php/Home/Admin/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" onclick="return confirm('确认删除?');" href="/blogs/admin.php/Home/Admin/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
