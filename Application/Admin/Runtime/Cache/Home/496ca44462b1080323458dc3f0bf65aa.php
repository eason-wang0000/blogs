...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/blogs/admin.php/Home/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">栏目管理</span></div>
        </div>
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="/blogs/admin.php/Home/Cate/sort"  method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/blogs/admin.php/Home/Cate/add"><i class="icon-font"></i>新增栏目</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td title="<?php echo ($vo["catename"]); ?>"><a target="_blank" href="#" title="内容"><?php echo ($vo["catename"]); ?></a>
                            </td>
                            <td>
                                <a class="link-update" href="/blogs/admin.php/Home/Cate/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" onclick="return confirm('确认删除?');" href="/blogs/admin.php/Home/Cate/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
