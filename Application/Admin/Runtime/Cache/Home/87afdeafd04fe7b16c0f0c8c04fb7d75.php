...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/blogs/admin.php/Home/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">文章管理</span></div>
        </div>
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="/blogs/admin.php/Home/Article/sort"  method="post" >
                <div class="result-title">
                    <div class="result-list">
                        <a href="/blogs/admin.php/Home/Article/add"><i class="icon-font"></i>新增文章</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td title="<?php echo ($vo["title"]); ?>"><a target="_blank" title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></a>
                            </td>
                             <td>

                             <?php if($vo['pic'] != ''): ?><img src="/blogs/<?php echo ($vo["pic"]); ?>" height="50"/>
                                 <?php else: ?>
                                 暂无缩略图<?php endif; ?>
                            </td>
                           
                             <td><?php echo ($vo["catename"]); ?>
                            </td>
                            <td>
                                <a class="link-update" href="/blogs/admin.php/Home/Article/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" onclick="return confirm('确认删除?');" href="/blogs/admin.php/Home/Article/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
