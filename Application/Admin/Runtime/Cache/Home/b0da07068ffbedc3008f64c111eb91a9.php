...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font">&#xe06b;</i><span style="color: red">PHP中文网个人博客</span></div>
        </div>
        <div class="result-wrap">
            ...
            <div class="result-content">
                <div class="short-wrap">
                    <a href="/blogs/admin.php/Home/Article/add"><i class="icon-font">&#xe001;</i>新增作品</a>
                    <!-- <a href="#"><i class="icon-font">&#xe005;</i>新增博文</a> -->
                    <a href="/blogs/admin.php/Home/Cate/add"><i class="icon-font">&#xe048;</i>新增作品分类</a>
        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    <li>
                        <label class="res-lab">PHP中文网5群：</label><span class="res-info">374224296</span>
                    </li>
